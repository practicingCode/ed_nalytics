...
// console.log("-------------");
// console.log(draw_me); 
var viz_bar_chart = document.getElementById("viz_bar_chart");
...
par = viz_bar_chart.parentNode;
par.insertBefore(new_drop, viz_bar_chart); // here we take the reference get parent and add it beside reference after
